...
> เฟส: **A** ✅ ฐาน PAT (table+middleware+ตั้งค่า) → **B** ✅ scope-gate endpoint + `/api/me/today` → **C** ~~ต่อ `/checkin`~~ ยกเลิก (SeedOffice เป็นระบบงานรายวันแทน) · **T3** ✅ สร้าง task ผ่าน PAT + discovery → **D** MCP (ถัดไป)
